...
do
  cmd="""#!/bin/bash
    ...
    MethylDackel extract -@ 16 $MUGQIC_INSTALL_HOME_DEV/genomes/species/Homo_sapiens.GRCh38/genome/bisulfite/Homo_sapiens.GRCh38.fa output/${sample}/${sample}_sra_2.trimmed_bismark_bt2_pe.sorted.bam -o MethylDackel/${sample}/${sample}"""
